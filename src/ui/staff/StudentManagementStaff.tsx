...
export const StudentManagementStaff: React.FC = () => {
  const { user } = useAuth();
  ...
  if (!colors) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-red-500">Lỗi: Không thể load color scheme</div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2" style={{ color: colors.text }}>
          Quản Lý Sinh Viên (STAFF)
        </h1>
        <p className="text-lg" style={{ color: colors.textLight }}>
          Xem và cập nhật thông tin sinh viên cơ bản
        </p>
      </div>
                  ...
                  >
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                        student.statusSV === "ACTIVE"
                          ? "bg-green-100 text-green-800"
                          : student.statusSV === "INACTIVE"
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            >
              <h3
                ...
                style={{ color: colors.text }}
              >
                Chỉnh Sửa Thông Tin Sinh Viên (STAFF)
              </h3>
              <p className="text-sm" style={{ color: colors.textLight }}>
                Chỉ được phép cập nhật thông tin cơ bản
              </p>
            </div>
