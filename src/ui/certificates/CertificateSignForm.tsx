...
const CertificateSignForm: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const response = await apiCall('/api/certificates/sign', {
        method: 'POST',
        body: form,
        // ⚠️ Không set Content-Type = application/json ở đây
        headers: {}, // Để fetch tự set boundary cho multipart
      });
