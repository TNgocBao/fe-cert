      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          <button
            ...
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium rounded-lg hover-lift shadow-glow transition-all duration-300"
          >
        ...
        {requests.length === 0 ? (
          <div className="bg-white rounded-xl shadow-lg p-12 text-center">
            <div className="mx-auto h-24 w-24 text-purple-400 mb-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {requests.map((request) => (
              <div key={request.id} className="bg-white rounded-xl shadow-lg hover-lift border border-gray-200 overflow-hidden">
                <div className="p-6">
                  {/* Status Badge */}
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Mẫu: {request.templateName || 'Chứng chỉ tốt nghiệp'}</p>
                    </div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {request.reviewedAt && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">{new Date(request.reviewedAt).toLocaleDateString('vi-VN')}</span>
                        </div>
                      )}

                      {request.directorReviewedAt && (
                        <div className="flex justify-between">
                          <span className="text-gray-500">Giám đốc duyệt:</span>
                          <span className="font-medium">{new Date(request.directorReviewedAt).toLocaleDateString('vi-VN')}</span>
                        </div>
                      )}
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    {request.certificateId && (
                      <a
                        ...
                        className="w-full inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm font-medium rounded-lg hover-lift shadow-glow transition-all duration-300"
                      >
